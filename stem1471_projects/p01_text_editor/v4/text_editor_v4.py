...
def newFile():
    ...
    if CURRENT_EDIT_STATUS == 'UNSAVED':
        messagebox.showinfo("File", "Please save your current work!")
        return
    else:
...
def save():
    ...
    # show message
    messagebox.showinfo("File", f'{filename} is saved now.')
...
def saveas():
    ...
    # file name dialog
    topframe = Toplevel()
    topframe.geometry("300x180+810+390")
...
# font family
familyVar = StringVar()
familyList = ("Arial", "Times", "Courier")
