...
def change_fontweight():
    TEXT_FONT.config(weight="bold")
    text.configure(font=TEXT_FONT)


def change_fontweight_2():
    TEXT_FONT.config(weight="normal")
    text.configure(font=TEXT_FONT)
...
btn1_weight = Button(frame_toolbar, text="Bold", command=change_fontweight)
btn2_weight = Button(frame_toolbar, text="Normal", command=change_fontweight_2)
...
btn1_weight.pack(side=LEFT)
btn2_weight.pack(side=LEFT)
