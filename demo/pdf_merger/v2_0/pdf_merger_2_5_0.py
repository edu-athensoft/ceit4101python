...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.settings_frame_text_label.grid(row=0, column=0, columnspan=3, padx=30, pady=20)
        ...
        self.save_to_path_entry.grid(row=1, column=0, padx=20, pady=10, sticky="w")

        # Create "Select Folder" button that opens a file dialog to choose a folder
        self.select_folder_button = customtkinter.CTkButton(self.settings_frame, text="Select Folder",
                                                            command=self.select_folder)
        self.select_folder_button.grid(row=1, column=1, padx=20, pady=10)

        # Create "Reset Folder" button to reset to Desktop
        self.reset_folder_button = customtkinter.CTkButton(self.settings_frame, text="Reset",
                                                           command=self.reset_folder)
        self.reset_folder_button.grid(row=1, column=2, padx=10, pady=10)
    ...
    def merge_pdfs(self):
        ...
        desktop_path = os.path.join(current_path, "merged_output.pdf")
