...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Athensoft PDF Helper - Merger v2.4.1")
        ...
        # Create a scrollable table frame (vertical scrolling)
        self.table_frame = customtkinter.CTkScrollableFrame(self.home_frame, corner_radius=0, fg_color="transparent",
                                                            bg_color="#ffffff")

        # Grid the scrollable frame
        self.table_frame.grid(row=2, column=0, padx=20, pady=20, sticky="nsew")

        # Vertical scrollbar is managed automatically by CTkScrollableFrame, so no need for manual yview configuration
        ...
        self.merge_button.grid(row=4, column=0, padx=20, pady=20)
