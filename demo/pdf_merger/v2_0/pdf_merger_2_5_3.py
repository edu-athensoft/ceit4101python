...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Athensoft PDF Helper - Merger v2.5.3")
        ...
        # Add "Edit Save Path" button to the button_frame
        ...
        # -------
        # Create a footer frame to be placed at the bottom of home_frame
        ...
        self.home_footer_frame.grid(row=6, column=0, padx=20, pady=(0,20), sticky="nsew")

        # Configure the column to expand with the window for proper alignment
        self.home_frame.grid_rowconfigure(6, weight=1)
        self.home_frame.grid_columnconfigure(0, weight=1)

        # Create a label inside the footer frame to display the current value of save_to_path_entry
        ...
        # self.save_to_path_label.grid(row=0, column=0, padx=10, pady=(0, -5), sticky="nw")
        # self.save_to_path_entry.get()
