...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Athensoft PDF Helper - Merger v2.4.3")
        ...
        self.select_all_button = customtkinter.CTkButton(self.button_frame, text="Select All", command=self.select_all, width=70)
        self.select_all_button.grid(row=0, column=2, padx=10, pady=5)

        # Add "Unselect All" button to the button_frame
        self.unselect_all_button = customtkinter.CTkButton(self.button_frame, text="Unselect All", command=self.unselect_all, width=70)
        self.unselect_all_button.grid(row=0, column=3, padx=10, pady=5)

        # Add "Remove" button below the table
        self.remove_button = customtkinter.CTkButton(self.button_frame, text="Remove", command=self.remove_selected, width=70)
        self.remove_button.grid(row=0, column=4, padx=10, pady=5)
