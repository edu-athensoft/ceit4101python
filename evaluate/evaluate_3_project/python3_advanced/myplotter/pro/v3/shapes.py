...
class Rectangle(Shape2D):
    ...
    def __str__(self):
        return f'{__class__.__name__}[shapeType={self.getShapeType()},shapeColor={self.getShapeColor()},a={self.width},b={self.height}]'
...
class Circle(Shape2D):
    ...
    def __str__(self):
        return f'{__class__.__name__}[shapeType={self.getShapeType()},shapeColor={self.getShapeColor()},radius={self.r:.3f}]'
...
class RightTriangle(Shape2D):
    ...
    def __str__(self):
        return f'{__class__.__name__}[shapeType={self.getShapeType()},shapeColor={self.getShapeColor()},a={self.a}, b={self.b}, c(hypotenuse)={self.c:.3f}]'
